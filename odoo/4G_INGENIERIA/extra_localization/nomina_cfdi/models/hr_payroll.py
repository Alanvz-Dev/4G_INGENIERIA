...
class HrPayslip(models.Model):
    ...
    def get_worked_day_lines(self, contracts, date_from, date_to):
        ...
        for contract in contracts.filtered(lambda contract: contract.resource_calendar_id):
                ...
                if date_start:
                    ...
                    if datetime.datetime.today().year > date_start.year:
                        ...
                        if d_from <= date_start <= d_to:
                            diff_date = day_to - datetime.datetime.strptime(contract.date_start, "%Y-%m-%d")
            ...
            date_start_1 = datetime.datetime.strptime(date_start_1, "%Y-%m-%d")
            d_from_1 = datetime.datetime.strptime(date_from, "%Y-%m-%d")
            d_to_1 = datetime.datetime.strptime(date_to, "%Y-%m-%d")
