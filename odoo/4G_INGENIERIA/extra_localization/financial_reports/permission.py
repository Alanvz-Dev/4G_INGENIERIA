...
group_id = input('Ingresa el nombre del grupo --> ')
prefix = input('Ingresa el prefijo del grupo --> ')
perm_read = input('Leer:     0/1 --> ')
perm_write = input('Escribir: 0/1 --> ')
perm_create = input('Crear:    0/1 --> ')
perm_unlink = input('Eliminar: 0/1 --> ')
