...
class CuentasPorPagarProveedorModel(models.Model):
    _inherit = 'cuentas_por_pagar.complemento_de_pago_proveedor.model'
    ...
    def create(self, values):
        ...
        if not partner_id.aplica_repse=='no' or partner_id.aplica_repse==False:
        ...
        return super(CuentasPorPagarProveedorModel, self).create(values)
