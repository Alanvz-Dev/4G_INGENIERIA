...
class Employee(models.Model):
    ...
    idaxtraxng = fields.Integer(track_visibility='onchange')
    no_tarjeta = fields.Integer()
    cred_infonavit= fields.Integer()
    cred_fonacot= fields.Integer() 
    ...
    child_ids = fields.One2many('hr.employee', 'parent_id', string='Subordinates',track_visibility='onchange')
    coach_id = fields.Many2one('hr.employee', 'Coach',track_visibility='onchange')
    category_id = fields.Many2one('hr.employee.category', 'Categoria',track_visibility='onchange')
    category_id_max = fields.Many2one('hr.employee.category', 'Categoria Máxima',track_visibility='onchange')
...
class ImportarComidasWizard(models.TransientModel):
    _name = 'importar.comidas.wizard'
    _description = 'ImportarComidasWizard'
    
    @api.multi
    def importar_comidas(self):
        print("Hola")
        print(self)
