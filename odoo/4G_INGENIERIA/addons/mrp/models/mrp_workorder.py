...
class MrpWorkorder(models.Model):
    ...
    state = fields.Selection([
        ...
        default='pending')
    date_planned_start = fields.Datetime('Production xxx Date', related='production_id.date_planned_start', store=True)
    # fields.Datetime(
    ...
    duration_percent = fields.Integer(
        'Duration Deviation bb(%)', compute='_compute_duration',
    ...
    def _compute_duration(self):
        ...
        if self.duration_expected:
            ...
            print(100 * (self.duration_expected - self.duration) / self.duration_expected)
        else:
            ...
            if production_move.product_id.tracking != 'none' :
                ...
                if move_line:
                    ...
                    if production_move:
                        ...
                        vals = {'move_id': production_move.id,
